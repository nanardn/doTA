 	...
 	<section class="content">
		<section class="widget">
			...
			<div class="content" width="100">
				<form action="{{ URL::to('createlaporanbank') }}" method="post" enctype="multipart/form-data">
					{!! csrf_field() !!}
                    Nama Proyek 	:
				...
				<table id="myTable" border="0" width="100">
					<thead>
						...
						<tr>
							...
							<td><a href="{{ URL::to('/dashboard/detail_laporan_bank/'.$rc->id_laporan_b)}}"><button>Lihat</button></a></td>
